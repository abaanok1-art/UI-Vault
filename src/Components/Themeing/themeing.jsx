    ...
    <div className="theming-container">
      <div className="theming-header">
        ...
        <p className="theming-subtitle">
          UI Vault is powered by native CSS design tokens. Paste these variables into your `index.css` to customize accent glow, glass blurs, and surface levels across all components.
        </p>
      </div>
