...
export default function Sidebar({ isOpen, onClose }) {
  ...
  const navSections = [
    ...
    },
    {
      ...
      items: [
        { title: 'Buttons Stash', path: '/buttons', icon: <CgPlayButtonR />, badge: '60+' },
        { title: 'Cards Stash', path: '/cards', icon: <PiCardsBold />, badge: '40+' },
    ...
    },
    {
      ...
      items: [
        { title: 'Navbar Stash', path: '/Navbars', icon: <FaSitemap />, badge: '50+' }
      ]
    },
    {
