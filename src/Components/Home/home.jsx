...
export default function Home({ showToast }) {
  ...
  const cssSnippet = `/* UI Vault Glassmorphism Foundation */
:root {
    ...
    <div className="home-container-root">
      ...
      <section className="home-hero-section">
        ...
        <p className="home-hero-description">
          A modern vault of 300+ copy-paste React components styled with dark frosted glass, neon cyan glow vectors, and zero external framework bloat.
        </p>
