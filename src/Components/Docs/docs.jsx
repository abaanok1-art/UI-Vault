      ...
      <main className="docs-content">
        {activeSection === 'getting-started' && (
          <section className="docs-section">
            <h1 className="docs-heading">Getting Started with UI Vault</h1>
            <p className="docs-lead">
              UI Vault is a modern, modular component collection providing zero-dependency React components styled with dark glassmorphism and cyber neon aesthetics.
            </p>
