...
export default function ContactModal({ isOpen, onClose, showToast }) {
  ...
  const whatsappLink = 'https://wa.me/923340004884?text=Hi%20Abdul%20Moiz,%20I%20am%20contacting%20you%20from%20UI%20Vault!';
    ...
    try {
      ...
      const response = await fetch(`https://formsubmit.co/ajax/${targetEmail}`, {
        ...
        body: JSON.stringify({
          ...
          _subject: `New UI Vault Inquiry from ${formData.name} (${formData.topic})`,
          _captcha: 'false'
        })
      });
