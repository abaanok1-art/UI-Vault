  ...
  return (
    <div className="about-page-container">
      <div className="about-header">
        ...
        <h1 className="about-title">About UI Vault</h1>
      ...
      <div className="about-section">
        <h2 className="section-heading">Why Choose UI Vault?</h2>
      ...
      <div className="about-creator-card">
        ...
        <div className="creator-actions">
          <a
            href="https://wa.me/923340004884?text=Hi%20Abdul%20Moiz,%20I'm%20contacting%20you%20from%20UI%20Vault!"
            target="_blank"
